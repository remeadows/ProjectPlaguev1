...
extension UnitFactory {
    ...
    static let allUnits: [UnitInfo] = [
        ...
        UnitInfo(id: "source_t18_singularity_well", name: "Singularity Well", description: "Event horizon data collection. Harvests from black hole boundaries.", tier: .tier18, category: .source, unlockCost: 2e18, unlockRequirement: "Complete Campaign Level 18"),
        UnitInfo(id: "link_t18_singularity_bridge", name: "Singularity Bridge", description: "Event horizon bandwidth. Data skips through singularities.", tier: .tier18, category: .link, unlockCost: 1.8e18, unlockRequirement: "Complete Campaign Level 18"),
        UnitInfo(id: "sink_t18_singularity_forge", name: "Singularity Forge", description: "Event horizon processing. Infinite computation in finite space.", tier: .tier18, category: .sink, unlockCost: 2.2e18, unlockRequirement: "Complete Campaign Level 18"),
        UnitInfo(id: "defense_t18_singularity_wall", name: "Singularity Wall", description: "Event horizon defense. Attacks fall into the singularity forever.", tier: .tier18, category: .defense, unlockCost: 1.8e18, unlockRequirement: "Complete Campaign Level 18"),

        // MARK: - Tier 19 (Omniscient) - Campaign Level 19
        UnitInfo(id: "source_t19_omniscient_array", name: "Omniscient Array", description: "Near-complete universal awareness. Harvests from all points simultaneously.", tier: .tier19, category: .source, unlockCost: 2e19, unlockRequirement: "Complete Campaign Level 19"),
        UnitInfo(id: "link_t19_omnipresent_mesh", name: "Omnipresent Mesh", description: "Everywhere at once. Data exists at all points simultaneously.", tier: .tier19, category: .link, unlockCost: 1.8e19, unlockRequirement: "Complete Campaign Level 19"),
        UnitInfo(id: "sink_t19_omniscient_broker", name: "Omniscient Broker", description: "All-knowing trades. Perfect market knowledge from omniscience.", tier: .tier19, category: .sink, unlockCost: 2.2e19, unlockRequirement: "Complete Campaign Level 19"),
        UnitInfo(id: "defense_t19_omniguard", name: "Omniguard", description: "All-protective defense. Knows all attacks before they occur.", tier: .tier19, category: .defense, unlockCost: 1.8e19, unlockRequirement: "Complete Campaign Level 19"),

        // MARK: - Tier 20 (Reality) - Campaign Level 20
        UnitInfo(id: "source_t20_reality_tap", name: "Reality Core Tap", description: "Access to reality's source code. Harvests from the fabric of existence.", tier: .tier20, category: .source, unlockCost: 2e20, unlockRequirement: "Complete Campaign Level 19"),
        UnitInfo(id: "link_t20_reality_weave", name: "Reality Weave", description: "Woven into fabric. Data is part of reality's structure.", tier: .tier20, category: .link, unlockCost: 1.8e20, unlockRequirement: "Complete Campaign Level 19"),
        UnitInfo(id: "sink_t20_reality_synthesizer", name: "Reality Synthesizer", description: "Value from reality itself. Credits from existence.", tier: .tier20, category: .sink, unlockCost: 2.2e20, unlockRequirement: "Complete Campaign Level 19"),
        UnitInfo(id: "defense_t20_reality_fortress", name: "Reality Fortress", description: "Reality-level defense. Attacks contradict existence.", tier: .tier20, category: .defense, unlockCost: 1.8e20, unlockRequirement: "Complete Campaign Level 19"),

        // MARK: - Tier 21 (Prime) - Campaign Level 20
        UnitInfo(id: "source_t21_prime_nexus", name: "Prime Nexus Scanner", description: "First point of all information. Harvests from the origin of data.", tier: .tier21, category: .source, unlockCost: 2e21, unlockRequirement: "Complete Campaign Level 20"),
        UnitInfo(id: "link_t21_prime_conduit", name: "Prime Conduit", description: "Original pathway. The first and truest connection.", tier: .tier21, category: .link, unlockCost: 1.8e21, unlockRequirement: "Complete Campaign Level 20"),
        UnitInfo(id: "sink_t21_prime_processor", name: "Prime Processor", description: "Original computation. Processing at the source of mathematics.", tier: .tier21, category: .sink, unlockCost: 2.2e21, unlockRequirement: "Complete Campaign Level 20"),
        UnitInfo(id: "defense_t21_prime_bastion", name: "Prime Bastion", description: "Original protection. The first and ultimate defense.", tier: .tier21, category: .defense, unlockCost: 1.8e21, unlockRequirement: "Complete Campaign Level 20"),

        // MARK: - Tier 22 (Absolute)
        UnitInfo(id: "source_t22_absolute_harvester", name: "Absolute Zero Harvester", description: "Perfect extraction efficiency. Every bit of information captured.", tier: .tier22, category: .source, unlockCost: 2e22, unlockRequirement: "Complete Campaign Level 20"),
        UnitInfo(id: "link_t22_absolute_channel", name: "Absolute Channel", description: "Perfect lossless transfer. Zero entropy transmission.", tier: .tier22, category: .link, unlockCost: 1.8e22, unlockRequirement: "Complete Campaign Level 20"),
        UnitInfo(id: "sink_t22_absolute_converter", name: "Absolute Converter", description: "Perfect efficiency. Complete data-to-value conversion.", tier: .tier22, category: .sink, unlockCost: 2.2e22, unlockRequirement: "Complete Campaign Level 20"),
        UnitInfo(id: "defense_t22_absolute_shield", name: "Absolute Shield", description: "Perfect defense. Mathematically impossible to breach.", tier: .tier22, category: .defense, unlockCost: 1.8e22, unlockRequirement: "Complete Campaign Level 20"),

        // MARK: - Tier 23 (Genesis)
        UnitInfo(id: "source_t23_genesis_protocol", name: "Genesis Protocol", description: "Origin of all information. Harvests from the first moment of data.", tier: .tier23, category: .source, unlockCost: 2e23, unlockRequirement: "Complete Campaign Level 20"),
        UnitInfo(id: "link_t23_genesis_link", name: "Genesis Link", description: "Connection to origin. The link that was there at the beginning.", tier: .tier23, category: .link, unlockCost: 1.8e23, unlockRequirement: "Complete Campaign Level 20"),
        UnitInfo(id: "sink_t23_genesis_core", name: "Genesis Core", description: "Origin-level processing. Computation at the start of existence.", tier: .tier23, category: .sink, unlockCost: 2.2e23, unlockRequirement: "Complete Campaign Level 20"),
        UnitInfo(id: "defense_t23_genesis_ward", name: "Genesis Ward", description: "Origin-level protection. Shielded by the first moment.", tier: .tier23, category: .defense, unlockCost: 1.8e23, unlockRequirement: "Complete Campaign Level 20"),

        // MARK: - Tier 24 (Omega)
        UnitInfo(id: "source_t24_omega_stream", name: "Omega Stream", description: "The final data source. Harvests from the end of all things.", tier: .tier24, category: .source, unlockCost: 2e24, unlockRequirement: "Complete Campaign Level 20"),
        UnitInfo(id: "link_t24_omega_bridge", name: "Omega Bridge", description: "Final connection. The last bridge before the end.", tier: .tier24, category: .link, unlockCost: 1.8e24, unlockRequirement: "Complete Campaign Level 20"),
        UnitInfo(id: "sink_t24_omega_processor", name: "Omega Processor", description: "Final form processing. The ultimate evolution of computation.", tier: .tier24, category: .sink, unlockCost: 2.2e24, unlockRequirement: "Complete Campaign Level 20"),
        UnitInfo(id: "defense_t24_omega_barrier", name: "Omega Barrier", description: "Final defense. Nothing comes after the omega.", tier: .tier24, category: .defense, unlockCost: 1.8e24, unlockRequirement: "Complete Campaign Level 20"),

        // MARK: - Tier 25 (Infinite) - THE ULTIMATE
        UnitInfo(id: "source_t25_all_seeing", name: "The All-Seeing Array", description: "Ultimate consciousness harvesting. Omniscient awareness across all existence.", tier: .tier25, category: .source, unlockCost: 2e25, unlockRequirement: "Complete Campaign Level 20"),
        UnitInfo(id: "link_t25_infinite_backbone", name: "The Infinite Backbone", description: "Unlimited bandwidth incarnate. Infinite connection to infinite points.", tier: .tier25, category: .link, unlockCost: 1.8e25, unlockRequirement: "Complete Campaign Level 20"),
        UnitInfo(id: "sink_t25_infinite_core", name: "The Infinite Core", description: "Unlimited processing. Infinite computation, infinite conversion.", tier: .tier25, category: .sink, unlockCost: 2.2e25, unlockRequirement: "Complete Campaign Level 20"),
        UnitInfo(id: "defense_t25_impenetrable", name: "The Impenetrable", description: "Ultimate perimeter defense. Absolute, infinite, eternal protection.", tier: .tier25, category: .defense, unlockCost: 1.8e25, unlockRequirement: "Complete Campaign Level 20"),
    ]
